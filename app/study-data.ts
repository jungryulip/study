...
export const posts: DailyPost[] = [
  {
    ...
    summary:
      "클라우드 컴퓨팅과 AWS 주요 서비스, 리전과 EC2의 개념을 익혔다. 보안 그룹의 22·80·443번 포트를 구분하고 Ubuntu에 Java 17을 설치한 뒤, Gradle로 빌드한 Spring Boot JAR을 실행해 외부 HTTP 접속을 확인하고 실습 자원을 정리했다.",
    learned: [
      "클라우드 컴퓨팅·AWS 리전과 EC2",
      "보안 그룹과 22·80·443번 포트",
      "Ubuntu·Java 17과 Gradle 빌드",
      "Spring Boot 배포·접속 확인과 자원 정리",
    ],
    tags: ["AWS·EC2", "Spring Boot", "배포"],
    folder: "Java/20260922",
    readTime: 17,
  },
  {
    date: "2026-09-21",
  ...
  },
  {
    ...
    summary:
      "교안 4~6장에서 파일과 디렉터리의 생성·복사·이동·삭제를 연습하고, 아이노드를 기준으로 소프트 링크와 하드 링크의 차이를 확인했다. 사용자·그룹 정보를 살펴보고 계정 추가·삭제를 실습했으며, 소유권과 파일·디렉터리 권한은 교안 개념을 중심으로 정리했다.",
    learned: [
      "파일·디렉터리 생성, 복사, 이동과 삭제",
      "아이노드와 소프트·하드 링크의 차이",
      "Linux 사용자·그룹 정보와 계정 관리",
      "소유권과 파일·디렉터리 권한 개념",
    ],
    tags: ["Linux", "파일·링크", "사용자·권한"],
    folder: "Java/20260912",
    readTime: 18,
  },
  {
    date: "2026-09-11",
    day: "DAY 42",
    title: "리눅스 기초와 파일·디렉터리 구조",
    summary:
      "교안 1~4장에서 운영체제의 구성과 역할, 리눅스 배포판·활용 분야, VMware 기반 실습 환경과 파일 시스템 계층을 학습했다. 3장의 터미널과 셸은 개념만 정리하고 관련 실습은 하지 않았으며, 4장에서는 경로 이동과 파일·디렉터리 확인·생성·이동을 연습했다.",
    learned: [
      "운영체제의 구성 요소와 프로세스 관리",
      "리눅스 배포판과 가상 머신 실습 환경",
      "터미널·셸·셸 스크립트 개념",
      "파일 시스템 계층과 절대·상대 경로",
    ],
    tags: ["Linux", "운영체제", "파일 시스템"],
    folder: "Java/20260911",
    readTime: 16,
  },
  {
    date: "2026-09-10",
  ...
  },
  {
    ...
    summary:
      "Thymeleaf 폼의 회원 데이터를 Controller에서 받아 JPA로 저장·수정하고 H2에서 결과를 확인했다. Spring Security의 인증과 인가를 구분하고 BCrypt, DB 기반 UserDetailsService와 SecurityFilterChain으로 공개·로그인·관리자 URL을 나눠 검증했다.",
    learned: [
      "Thymeleaf 폼 바인딩과 JPA 저장·수정",
      "Post/Redirect/Get과 H2 데이터 확인",
      "Spring Security 인증·인가와 세션",
      "BCrypt·UserDetailsService·URL별 접근 제어",
    ],
    tags: ["Spring Boot", "Spring MVC", "Spring Security"],
    folder: "Java/20260909",
    readTime: 17,
  },
  {
    date: "2026-09-08",
  ...
  },
  {
    ...
    summary:
      "REST API를 Controller·Service·Repository 계층으로 분리하고 요청·응답 DTO로 엔티티의 내부 필드를 보호했다. 여러 건 저장에 트랜잭션을 적용하고 회원과 게시글의 다대일 관계, JPA Auditing과 게시글 CRUD를 구현해 Postman으로 검증했다.",
    learned: [
      "Controller·Service·Repository 계층 분리",
      "Request·Response DTO와 Entity 변환",
      "여러 건 저장의 Transaction과 롤백",
      "ManyToOne·JPA Auditing과 게시글 REST CRUD",
    ],
    tags: ["Spring Boot", "JPA", "Service·DTO"],
    folder: "Java/20260907",
    readTime: 16,
  },
  {
    date: "2026-09-05",

...
Oracle SQL과 Java 수업에서 직접 실습한 코드와 그날 배운 내용을 날짜별로 정리합니다.
...
| 날짜 | 주요 학습 내용 | 기록 |
| --- | --- | --- |
| 2026-07-30 | 계층형 질의, 데이터베이스 접속, Java·JVM·변수 | [DAY 09 보기](./20260730/) |
| 2026-07-29 | 인덱스, 뷰, 사용자 권한, Role, Synonym | [DAY 08 보기](./20260729/) |
| 2026-07-28 | 시퀀스, DDL, 데이터 사전, 무결성 제약조건 | [DAY 07 보기](./20260728/) |
...
직접 실행한 쿼리·Java 코드와 시행착오를 기록합니다.
